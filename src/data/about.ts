...
export const aboutParagraphs: string[] = [
  'With a solid foundation built on over 12 years of service at Hatton National Bank and a successful career spanning over 10 years with HNB Assurance, I stand as a leading figure in Sri Lanka\u2019s insurance industry.',
  ...
  'Since 2015, I have been recognized annually as a National Award Winner by HNB Assurance, showcasing my unwavering commitment to quality and client satisfaction. In 2024, I further elevated my professional standing by winning the coveted Platinum Quality Award.',
...
export const aboutStats = [
  ...
  { value: '10+', label: 'Years with HNB Assurance' },
